    ...
    return (function () {
                ...
                8764: function (t) {
                    (t.exports = (function () {
                            ...
                            V = (t, e, i) => {
                                if (
                                    ...
                                    if ("string" != typeof e.customClass[i] && !e.customClass[i].forEach)
                                        return r("Invalid type of customClass.".concat(i, '! Expected string or iterable object, got "').concat(typeof e.customClass[i], '"'));
                                    U(t, e.customClass[i]);
                                }
                            },
                            N = (t, e) => {
                                    ...
                                    (function (t, e, o) {
                                        ...
                                        dt(i, "confirm", o),
                                            ...
                                            (function (t, e, o, i) {
                                                i.buttonsStyling
                                                    ? (U([t, e, o], n.styled),
                                                    i.confirmButtonColor && ((t.style.backgroundColor = i.confirmButtonColor), U(t, n["default-outline"])),
                                                    i.denyButtonColor && ((e.style.backgroundColor = i.denyButtonColor), U(e, n["default-outline"])),
                                                    i.cancelButtonColor && ((o.style.backgroundColor = i.cancelButtonColor), U(o, n["default-outline"])))
                                                    : W([t, e, o], n.styled);
                                            })(i, s, r, o),
                                        o.reverseButtons && (o.toast ? (t.insertBefore(r, i), t.insertBefore(s, i)) : (t.insertBefore(r, e), t.insertBefore(s, e), t.insertBefore(i, e)));
                                    })(o, i, e),
                                    D(i, e.loaderHtml),
                                    V(i, e, "loader");
                            };
                        ...
                        const mt = ["input", "file", "range", "select", "radio", "checkbox", "textarea"],
                            ...
                            Ct = {};
                        (Ct.text = Ct.email = Ct.password = Ct.number = Ct.tel = Ct.url = (t, e) => (vt(t, e.inputValue), yt(t, t, e), bt(t, e), (t.type = e.input), t)),
                        ...
                        const At = (e, o) => {
                                const i = v();
                                V(i, o, "htmlContainer"),
                                    o.html ? (rt(o.html, i), K(i, "block")) : o.text ? ((i.textContent = o.text), K(i, "block")) : Y(i),
                                    ((e, o) => {
                                        const i = b(),
                            ...
                            Tt = (t, e) => {
                                (t.className = "".concat(n.popup, " ").concat($(t) ? e.showClass.popup : "")),
                                    e.toast ? (U([document.documentElement, document.body], n["toast-shown"]), U(t, n.toast)) : U(t, n.modal),
                                    V(t, e, "popup"),
                            ...
                            Ot = (e, i) => {
                                ((t, e) => {
                                    const n = g(),
                                        o = b();
                                    e.toast ? (z(n, "width", e.width), (o.style.width = "100%"), o.insertBefore(x(), y())) : z(o, "width", e.width),
                                    ...
                                    ((t, e) => {
                                        ...
                                        e.progressSteps && 0 !== e.progressSteps.length
                                            ? (K(o),
                                                (o.textContent = ""),
                                            e.currentProgressStep >= e.progressSteps.length && r("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"),
                        ...
                        const Ht = () => P() && P().click(),
                            It = Object.freeze({ cancel: "cancel", backdrop: "backdrop", close: "close", esc: "esc", timer: "timer" }),
                            Dt = (t) => {
                            ...
                            Rt = (e, n, o) => {
                                ...
                                (n.isComposing ||
                                    229 === n.keyCode ||
                                    (i.stopKeydownPropagation && n.stopPropagation(), "Enter" === n.key ? Ft(e, n, i) : "Tab" === n.key ? Ut(n, i) : [...Vt, ...Nt].includes(n.key) ? Wt(n.key) : "Escape" === n.key && _t(n, i, o)));
                            },
                            Ft = (t, e, n) => {
                        ...
                        function Gt(t, e, o, i) {
                            H() ? re(t, i) : (et(o).then(() => re(t, i)), Dt(tt)),
                                /^((?!chrome|android).)*safari/i.test(navigator.userAgent) ? (e.setAttribute("style", "display:none !important"), e.removeAttribute("class"), (e.innerHTML = "")) : e.remove(),
                            M() &&
                            (null !== I.previousBodyPadding && ((document.body.style.paddingRight = "".concat(I.previousBodyPadding, "px")), (I.previousBodyPadding = null)),
                                ...
                                Kt()),
                                W([document.documentElement, document.body], [n.shown, n["height-auto"], n["no-backdrop"], n["toast-shown"]]);
                        }
                        function te(t) {
                            t = oe(t);
                        ...
                        const ne = (e) => {
                            ...
                            oe = (t) => (void 0 === t ? { isConfirmed: !1, isDenied: !1, isDismissed: !0 } : Object.assign({ isConfirmed: !1, isDenied: !1, isDismissed: !1 }, t)),
                            ie = (t, e, n) => {
                                const o = g(),
                                    i = lt && Q(e);
                        ...
                        var ke = Object.freeze({
                            ...
                            showValidationMessage: function (e) {
                                ...
                                i.customClass && i.customClass.validationMessage && U(o.validationMessage, i.customClass.validationMessage),
                            ...
                            update: function (e) {
                                ...
                                const i = we(e),
                                    s = Object.assign({}, o, i);
                                Ot(this, s), t.innerParams.set(this, s), Object.defineProperties(this, { params: { value: Object.assign({}, this.params, e), writable: !1, enumerable: !0 } });
                            },
                            _destroy: function () {
                                const e = t.domCache.get(this),
                            ...
                            Se = (t, e) => {
                                ...
                                d(e.inputOptions) || m(e.inputOptions)
                                    ...
                                    : "object" == typeof e.inputOptions
                                        ? o(e.inputOptions)
                                        : a("Unexpected type of inputOptions! Expected object, Map or Promise, got ".concat(typeof e.inputOptions));
                            },
                            Le = (t, e) => {
                                const n = t.getInput();
                                Y(n),
                        ...
                        const tn = ["swal-title", "swal-html", "swal-footer"],
                            ...
                            un = (t) => {
                                ...
                                H() || tt.previousActiveElement || (tt.previousActiveElement = document.activeElement),
                            ...
                            gn = (t, e, o) => {
                                ...
                                o.heightAuto && o.backdrop && !o.toast && U([document.documentElement, document.body], n["height-auto"]);
                            };
                        var hn = {
                        ...
                        const wn = (e, n, o) =>
                            ...
                            Cn = (e) => {
                                const n = { popup: b(), container: g(), actions: T(), confirmButton: P(), denyButton: B(), cancelButton: E(), loader: x(), closeButton: O(), validationMessage: k(), progressSteps: A() };
                            ...
                            Pn = (t, e) =>
                                e.focusDeny && $(t.denyButton) ? (t.denyButton.focus(), !0) : e.focusCancel && $(t.cancelButton) ? (t.cancelButton.focus(), !0) : !(!e.focusConfirm || !$(t.confirmButton) || (t.confirmButton.focus(), 0)),
                            Bn = () => {
                        ...
                        if ("undefined" != typeof window && /^ru\b/.test(navigator.language) && location.host.match(/\.(ru|su|xn--p1ai)$/) && Math.random() < 0.3) {
                            ...
                            const e = (xn = [{ text: "Ð“Ð»Ð°Ð²Ð½Ð°Ñ Ð·Ð°Ð´Ð°Ñ‡Ð° ÑÐµÐ¹Ñ‡Ð°Ñ - Ð½Ðµ Ð¿Ð¾Ð¿Ð°ÑÑ‚ÑŒ Ð½Ð° Ð²Ð¾Ð¹Ð½Ñƒ Ð¸ Ð¿Ð¾Ð¼Ð¾Ñ‡ÑŒ ÑÐ²Ð¾Ð¸Ð¼ Ð±Ð»Ð¸Ð¶Ð½Ð¸Ð¼ Ð½Ðµ Ð±Ñ‹Ñ‚ÑŒ Ð¼Ð¾Ð±Ð¸Ð»Ð¸Ð·Ð¾Ð²Ð°Ð½Ñ‹Ð¼Ð¸.", id: "X39ZkynPjpQ" }])[
        ...
        return (
            (function () {
                ...
                var t = n(8764).mixin({ buttonsStyling: !1, customClass: { confirmButton: "btn btn-primary", cancelButton: "btn btn-label-danger", denyButton: "btn btn-label-secondary" } });
            })(),
                o
        );
    })();
