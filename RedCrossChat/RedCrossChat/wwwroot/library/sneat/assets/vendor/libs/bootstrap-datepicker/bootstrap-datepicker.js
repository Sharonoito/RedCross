                            ...
                            h.prototype = {
                                ...
                                _process_options: function (e) {
                                    ...
                                    (s.startDate
                                        ? s.startDate instanceof Date
                                            ...
                                            : (s.startDate = m.parseDate(s.startDate, o, s.language, s.assumeNearbyYear))
                                        : (s.startDate = -1 / 0)),
                                    s.endDate !== 1 / 0 &&
                                    (s.endDate
                                    ...
                                    return (
                                        arguments.length
                                            ? (t.each(
                                                ...
                                                (a = !0))
                                            : ((i = (i = this.isInput ? this.element.val() : this.element.data("date") || this.inputField.val()) && this.o.multidate ? i.split(this.o.multidateSeparator) : [i]),
                                ...
                                fillDow: function () {
                                    if (this.o.showWeekDays) {
                                        ...
                                        for (this.o.calendarWeeks && (i += '<th class="cw">&#160;</th>'); e < this.o.weekStart + 7; )
                                            (i += '<th class="dow'), -1 !== t.inArray(e, this.o.daysOfWeekDisabled) && (i += " disabled"), (i += '">' + D[this.o.language].daysMin[e++ % 7] + "</th>");
                                ...
                                _fill_yearsView: function (i, a, s, n, o, r, h) {
                                    for (
                                        ...
                                        v === m && l.push("focused"),
                                        h !== t.noop &&
                                        ((c = h(new Date(v, 0, 1))) === e ? (c = {}) : "boolean" == typeof c ? (c = { enabled: c }) : "string" == typeof c && (c = { classes: c }),
                                ...
                                fill: function () {
                                    ...
                                    if (!isNaN(r) && !isNaN(h)) {
                                        ...
                                        for (var _, C, T = []; w.valueOf() < b; ) {
                                            ...
                                            ((n = this.o.beforeShowDay(this._utc_to_local(w))) === e ? (n = {}) : "boolean" == typeof n ? (n = { enabled: n }) : "string" == typeof n && (n = { classes: n }),
                                ...
                                click: function (e) {
                                    ...
                                    ((s.hasClass("month") || s.hasClass("year") || s.hasClass("decade") || s.hasClass("century")) &&
                                        (this.viewDate.setUTCDate(1),
                                            1,
                                            1 === this.viewMode
                                                ? ((o = s.parent().find("span").index(s)), (n = this.viewDate.getUTCFullYear()), this.viewDate.setUTCMonth(o))
                                                : ((o = 0), (n = Number(s.text())), this.viewDate.setUTCFullYear(n)),
                                            this._trigger(m.viewModes[this.viewMode - 1].e, this.viewDate),
                                            this.viewMode === this.o.minViewMode ? this._setDate(i(n, o, 1)) : (this.setViewMode(this.viewMode - 1), this.fill()))),
                                ...
                                dayCellClick: function (e) {
                                    var i = t(e.currentTarget).data("date"),
                                        a = new Date(i);
                                    this.o.updateViewDate &&
                                    (a.getUTCFullYear() !== this.viewDate.getUTCFullYear() && this._trigger("changeYear", this.viewDate), a.getUTCMonth() !== this.viewDate.getUTCMonth() && this._trigger("changeMonth", this.viewDate)),
                                        this._setDate(a);
                                },
                                            ...
                                            this.each(function () {
                                                ...
                                                if (!n) {
                                                    var r = d(this, "date"),
                                                        ...
                                                        p = t.extend({}, f, u, r, o);
                                                    e.hasClass("input-daterange") || p.inputs ? (t.extend(p, { inputs: p.inputs || e.find("input").toArray() }), (n = new l(this, p))) : (n = new h(this, p)), e.data("datepicker", n);
                                                }
                                    ...
                                    parseDate: function (i, s, n, o) {
                                        ...
                                        if ((i in f && (i = f[i]), /^[\-+]\d+[dmwy]([\s,]+[\-+]\d+[dmwy])*$/i.test(i))) {
                                            for (r = i.match(/([\-+]\d+)([dmwy])/gi), i = new Date(), c = 0; c < r.length; c++)
                                                (l = r[c].match(/([\-+]\d+)([dmwy])/i)), (d = Number(l[1])), (u = p[l[2].toLowerCase()]), (i = h.prototype[u](i, d));
