                        ...
                        function k(p, v) {
                            ...
                            function R(e, t, n, a) {
                                ...
                                return (
                                    ...
                                    -1 === e.indexOf("hidden") && 0 === C(t, b.now) && ((b.todayDateElem = o), o.classList.add("today"), o.setAttribute("aria-current", "date")),
                                        i
                                            ? ((o.tabIndex = -1),
                                            we(t) &&
                                    ...
                                    : a
                                        ? (function (e, t) {
                                            for (var n = -1 === e.className.indexOf("Month") ? e.dateObj.getMonth() : b.currentMonth, a = t > 0 ? b.config.showMonths : -1, i = t > 0 ? 1 : -1, o = n - b.currentMonth; o != a; o += i)
                                                for (
                                                    var r = b.daysContainer.children[o], l = n - b.currentMonth === o ? e.$i + t : t < 0 ? r.children.length - 1 : 0, c = r.children.length, s = l;
                                                    s >= 0 && s < c && s != (t > 0 ? c : -1);
                                                    s += i
                                                ) {
                                                    var d = r.children[s];
                                        ...
                                        case 40:
                                            ...
                                            (b.daysContainer && void 0 !== t.$i) || t === b.input || t === b.altInput
                                                ...
                                                : t === b.currentYearElement
                                                    ? ee(b.currentYear - s)
                                                    : b.config.enableTime && (!r && b.hourElement && b.hourElement.focus(), _(e), b._debouncedChange());
                                            break;
                                        case 9:
                                            if (r) {
                            ...
                            function oe(e, t) {
                                if ((void 0 === t && (t = "flatpickr-day"), 1 === b.selectedDates.length && (!e || (e.classList.contains(t) && !e.classList.contains("flatpickr-disabled"))))) {
                                    for (
                                        ...
                                        te(new Date(s), !0) || ((r = r || (s > i && s < o)), s < a && (!l || s > l) ? (l = s) : s > a && (!c || s < c) && (c = s));
                                    Array.from(b.rContainer.querySelectorAll("*:nth-child(-n+" + b.config.showMonths + ") > ." + t)).forEach(function (t) {
                                        ...
                                        d >= l && (0 === c || d <= c) && ((o = a), (s = n), (i = d) > Math.min(o, s) && i < Math.max(o, s)) && t.classList.add("inRange")));
                                    });
                                }
                            }
                            function re() {
                            ...
                            (b.parseDate = y({ config: b.config, l10n: b.l10n })),
                                ...
                                (b.clear = function (e, t) {
                                    if (
                                        ...
                                        !0 === t && ((b.currentYear = b._initialDate.getFullYear()), (b.currentMonth = b._initialDate.getMonth())),
                                ...
                                (b.open = function (e, t) {
                                    ...
                                    if (!b._input.disabled && !b.config.inline) {
                                        var a = b.isOpen;
                                        (b.isOpen = !0),
                                        a || (b.calendarContainer.classList.add("open"), b._input.classList.add("active"), De("onOpen"), de(t)),
                                        !0 === b.config.enableTime &&
                            ...
                            function ye() {
                                ...
                                (b.yearElements.forEach(function (e, t) {
                                    ...
                                    n.setMonth(b.currentMonth + t),
                                        b.config.showMonths > 1 || "static" === b.config.monthSelectorType
                                            ? (b.monthElements[t].textContent = h(n.getMonth(), b.config.shorthandCurrentMonth, b.l10n) + " ")
                                            : (b.monthsDropdownContainer.value = n.getMonth().toString()),
                                        (e.value = n.getFullYear().toString());
                                }),
                                    (b._hidePrevMonthArrow =
                                        void 0 !== b.config.minDate && (b.currentYear === b.config.minDate.getFullYear() ? b.currentMonth <= b.config.minDate.getMonth() : b.currentYear < b.config.minDate.getFullYear())),
                            ...
                            return (
                                (function () {
                                    ...
                                    (b.selectedDates.length || b.config.noCalendar) && (b.config.enableTime && F(b.config.noCalendar ? b.latestSelectedDateObj : void 0), Me(!1)),
                                        I();
