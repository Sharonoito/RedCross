                ...
                9612: function (t) {
                    self,
                        (t.exports = (() => {
                            ...
                            t.r(o), t.d(o, { adjustableInputNumbers: () => p, createElementFromString: () => s, createFromTemplate: () => a, eventPath: () => l, off: () => r, on: () => i, resolveElement: () => c });
                            ...
                            function p(t, e = (t) => t) {
                                ...
                                i(t, "focus", () => i(window, "wheel", o, { passive: !1 })), i(t, "blur", () => r(window, "wheel", o));
                            }
                            ...
                            function y(t, e, o, n) {
                                return (e /= 100), (o /= 100), [...b(255 * (1 - u(1, (t /= 100) * (1 - (n /= 100)) + n)), 255 * (1 - u(1, e * (1 - n) + n)), 255 * (1 - u(1, o * (1 - n) + n)))];
                            }
                            function g(t, e, o) {
                                e /= 100;
                            ...
                            function C(t) {
                                const e = {
                                        ...
                                        _keyboard(t) {
                                            ...
                                            if (document.activeElement === o.wrapper) {
                                                ...
                                                if ("keydown" === n && (r || s || a || l)) {
                                                    let n = 0,
                                                        i = 0;
                                                    "v" === o ? (n = r || s ? 1 : -1) : "h" === o ? (n = r || s ? -1 : 1) : ((i = r ? -1 : a ? 1 : 0), (n = l ? -1 : s ? 1 : 0)),
                                        ...
                                        _tapstop() {
                                            e.options.onstop(), r(document, ["mouseup", "touchend", "touchcancel"], e._tapstop), r(document, ["mousemove", "touchmove"], e._tapmove);
                                        },
                                        trigger() {
                                            e._tapmove();
                                        },
                                        ...
                                        destroy() {
                                            ...
                                            r(document, ["keydown", "keyup"], n), r([t.wrapper, t.element], "mousedown", o), r([t.wrapper, t.element], "touchstart", o, { passive: !1 });
                                        },
                                    },
                                    { options: o, _tapstart: n, _keyboard: s } = e;
                                return i([o.wrapper, o.element], "mousedown", n), i([o.wrapper, o.element], "touchstart", n, { passive: !1 }), i(document, ["keydown", "keyup"], s), e;
                            }
                            function $(t = {}) {
                            ...
                            const k = { variantFlipOrder: { start: "sme", middle: "mse", end: "ems" }, positionFlipOrder: { top: "tbrl", right: "rltb", bottom: "btrl", left: "lrbt" }, position: "bottom", margin: 8 };
                            function S(t, e, o) {
                            ...
                            class O {
                                constructor(t) {
                                    S(this, "_initializingActive", !0),
                                        ...
                                        S(this, "_eventListener", { init: [], save: [], hide: [], show: [], clear: [], change: [], changestop: [], cancel: [], swatchselect: [] }),
                                    ...
                                    (this._nanopop = ((t, e, o) => {
                                        ...
                                        return {
                                            update(t = n) {
                                                ...
                                                return ((t, e, o) => {
                                                    const { container: n, margin: i, position: r, variantFlipOrder: s, positionFlipOrder: a } = { container: document.documentElement.getBoundingClientRect(), ...k, ...o },
                                        ...
                                        const { components: e, useAsButton: o, inline: n, appClass: i, theme: r, lockOpacity: s } = t.options,
                                            ...
                                            p = a(
                                                `\n      <div :ref="root" class="pickr">\n\n        ${o ? "" : '<button type="button" :ref="button" class="pcr-button"></button>'}\n\n        <div :ref="app" class="pcr-app ${
                                                    i || ""
                                                }" data-theme="${r}" ${n ? 'style="position: unset"' : ""} aria-label="${c("ui:dialog")}" role="window">\n          <div class="pcr-selection" ${l(
                                                    e.palette
                                                    ...
                                                    "aria:input"
                                                )}">\n\n            <input :arr="options" class="pcr-type" data-type="HEXA" value="${s ? "HEX" : "HEXA"}" type="button" ${l(
                                                    e.interaction.hex
                                                )}>\n            <input :arr="options" class="pcr-type" data-type="RGBA" value="${s ? "RGB" : "RGBA"}" type="button" ${l(
                                                    e.interaction.rgba
                                                )}>\n            <input :arr="options" class="pcr-type" data-type="HSLA" value="${s ? "HSL" : "HSLA"}" type="button" ${l(
                                                    e.interaction.hsla
                                                )}>\n            <input :arr="options" class="pcr-type" data-type="HSVA" value="${s ? "HSV" : "HSVA"}" type="button" ${l(
                                                    e.interaction.hsva
                                            ...
                                            palette: C({
                                                ...
                                                onchange(o, n) {
                                                    ...
                                                    (this.element.style.background = p),
                                                        ...
                                                        a.comparison ? a.useAsButton || t._lastColor || l.style.setProperty("--pcr-color", p) : (s.button.style.setProperty("--pcr-color", p), s.button.classList.remove("clear"));
                                ...
                                _parseLocalColor(t) {
                                    const { values: e, type: o, a: n } = (function (t) {
                                            t = t.match(/^[a-zA-Z]+$/)
                                                ? (function (t) {
                                ...
                                addSwatch(t) {
                                    ...
                                    if (e) {
                                        const { _swatchColors: t, _root: o } = this,
                                            n = w(...e),
                                            r = s(`<button type="button" style="--pcr-color: ${n.toRGBA().toString(0)}" aria-label="${this._t("btn:swatch")}"/>`);
                                        return (
                                ...
                                destroy() {
                                    cancelAnimationFrame(this._setupAnimationFrame), this._eventBindings.forEach((t) => r(...t)), Object.keys(this._components).forEach((t) => this._components[t].destroy());
                                }
                                destroyAndRemove() {
                                    this.destroy();
